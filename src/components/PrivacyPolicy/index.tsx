...
export default function PrivacyPolicy({ onClick }: PrivacyPolicyProps) {
  return (
    <Wrapper onClick={onClick} cssClass="privacypolicy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Events Board.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Events Board, accessible from{" "}
            <a
              href="https://hristovcodes.github.io/Events-Board/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://hristovcodes.github.io/Events-Board/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: ivailohristov1990@gmail.com</li>
      </ul>
    </Wrapper>
  );
}
